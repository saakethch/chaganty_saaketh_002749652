...
public class CustomerJFrame extends javax.swing.JFrame {
    ...
    public CustomerJFrame(Business business, Branch branch, UserAccount useraccount) {
        ...
        this.customer = this.business.findCustomer(useraccount.getAccountId());
        cusName.setText(this.business.findCustomer(useraccount.getAccountId()).getName());
    ...
    public void populateRR() {
        ...
        if (rrs.size() > 0) {
            for (RentalRequest rr : rrs) {
                ...
                row[4] = rr.getStatus();
                row[5] = rr.getMaterial().getBranch_name();
                rrTable.addRow(row);
            }
        }
    ...
    private void initComponents() {
        ...
        rentalsTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Price", "Material ", "Duration", "Status", "Library"
            }
        ));
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                    ...
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addComponent(matId, javax.swing.GroupLayout.DEFAULT_SIZE, 99, Short.MAX_VALUE)
    ...
    private void rentRequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rentRequestActionPerformed
        // TODO add your handling code here:
        // Check unique rental req
        RentalRequest currRR = this.business.findCustomer(this.useraccount.getAccountId()).getCurrentRental();
        Boolean validationsDone = false;
        if (currRR == null) {
            validationsDone = true;
        } else if (currRR.getStatus() == "Returned" || currRR.getStatus() == "Rejected") {
            validationsDone = true;
        } else {
            for( RentalRequest cusRR: this.customer.getRentalRequestHistory()){
                if(cusRR.getId().equals(this.selectedMat == "mag" ? this.selectedMag.getId() : this.selectedBook.getId())){
        ...
        if (validationsDone) {
            ...
            JOptionPane.showMessageDialog(null, "Material already in Requests");
        }
    ...
    private void returnMatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_returnMatActionPerformed
        ...
        String mat_br = (String) rentalsTable.getValueAt(selectedRow, 5);
        this.branch = this.business.findBranchByName(mat_br);
        if ((String) rentalsTable.getValueAt(selectedRow, 4) == "Rented") {
            this.business.returnedReq(this.useraccount.getAccountId());
            this.branch.getLibrary().returnedRentalReq(rr_id);
    ...
    private void selectRentalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_selectRentalActionPerformed
        ...
        String rr_id = (String) rentalsTable.getValueAt(selectedRow, 0);
        String mat_br = (String) materialsTable.getValueAt(selectedRow, 10);
        this.selectedRR = this.business.findBranchByName(mat_br).getLibrary().getRentalRequests().findRR(rr_id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomerJFrame.class  
